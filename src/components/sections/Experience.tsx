...
const Experience = () => {
  ...
  return CheckSections("experience") ? (
    <div className="flex-col">
        ...
        <svg
          ...
          onClick={() =>
            updateSettingsSectionIndex(
              data.settingsSectionIndex === "experience" ? "" : "experience"
            )
          }
        >
          <path
      ...
      {data.settings.experience.sections.map((section: any, index: number) => {
        return (
          <div
            key={"ex" + index}
            style={{ color: data.settings.experience.settings.textColor }}
            className={
              data.settings.experience.settings.fontSize +
              " flex " +
              data.settings.experience.settings.textPosition
            }
          >
